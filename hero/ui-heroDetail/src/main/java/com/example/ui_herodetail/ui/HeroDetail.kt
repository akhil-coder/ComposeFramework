                ...
                item {
                    Column {
                        val painter = rememberImagePainter(
                            ...
                            imageLoader = imageLoader,
                            builder = {
                                placeholder(if (isSystemInDarkTheme()) com.example.ui_herodetail.R.drawable.black_background else com.example.ui_herodetail.R.drawable.white_background)
                            }
                        )
                        Image(
                            modifier = Modifier
            ...
            Row(
                ...
                Column(
                    ...
                    Row( // STR
                        ...
                        Text(
                            text = "${stringResource(com.example.ui_herodetail.R.string.strength)}:",
                    ...
                    Row( // AGI
                        ...
                        Text(
                            text = "${stringResource(com.example.ui_herodetail.R.string.agility)}:",
                            style = MaterialTheme.typography.body2,
                        )
                        Row {
                            Text(
                    ...
                    Row( // INT
                        ...
                        Text(
                            text = "${stringResource(com.example.ui_herodetail.R.string.intelligence)}:",
                            style = MaterialTheme.typography.body2,
                        )
                        Row {
                            Text(
                    ...
                    Row( // HP
                        ...
                        Text(
                            text = "${stringResource(com.example.ui_herodetail.R.string.health)}:",
                            style = MaterialTheme.typography.body2,
                        )
                ...
                Column(
                    ...
                    Row( // Atk Range
                        ...
                        Text(
                            modifier = Modifier
                                .padding(bottom = 8.dp),
                            text = "${stringResource(com.example.ui_herodetail.R.string.attack_range)}:",
                            style = MaterialTheme.typography.body2,
                        )
                        Text(
                            modifier = Modifier
                    ...
                    Row( // projectile speed
                        ...
                        Text(
                            modifier = Modifier
                                .padding(bottom = 8.dp),
                            text = "${stringResource(com.example.ui_herodetail.R.string.projectile_speed)}:",
                            style = MaterialTheme.typography.body2,
                        )
                        Text(
                            modifier = Modifier
                    ...
                    Row( // Move speed
                        ...
                        Text(
                            modifier = Modifier
                                .padding(bottom = 8.dp),
                            text = "${stringResource(com.example.ui_herodetail.R.string.move_speed)}:",
                            style = MaterialTheme.typography.body2,
                        )
                        Text(
                            modifier = Modifier
                    ...
                    Row( // Attack damage
                        ...
                        Text(
                            modifier = Modifier
                                .padding(bottom = 8.dp),
                            text = "${stringResource(com.example.ui_herodetail.R.string.attack_dmg)}:",
                            style = MaterialTheme.typography.body2,
                        )
